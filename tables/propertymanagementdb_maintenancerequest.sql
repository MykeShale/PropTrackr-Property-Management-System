...
CREATE TABLE `maintenancerequest` (
  ...
  CONSTRAINT `maintenancerequest_ibfk_1` FOREIGN KEY (`PropertyID`) REFERENCES `property` (`PropertyID`) ON DELETE CASCADE
...
INSERT INTO `maintenancerequest` VALUES (1,1,'Leaking roof','2025-05-13','Pending');
